...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Wazeer — Your AI growth partner for selling online" },
      ...
      { property: "og:title", content: "Wazeer — Your AI growth partner for selling online" },
      ...
      { name: "twitter:title", content: "Wazeer — Your AI growth partner for selling online" },
